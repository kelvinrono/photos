...
class ImageTestClass(TestCase):
    ...
    def test_update_image(self):
        self.new_image.save_image()
        self.new_image.update_image(self.new_image.id, 'images/kelvin.jpg')
        changed_img = Image.objects.filter(image='images/kelvin.jpg')
...
class CategoryTestClass(TestCase):
    ...
    def test_update_category(self):
        self.category.save_category()
        self.category.update_category(self.category.id, 'technology')
        changed_category = Category.objects.filter(name ='technology')
